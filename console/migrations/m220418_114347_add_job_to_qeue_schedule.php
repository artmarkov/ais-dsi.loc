...
class m220418_114347_add_job_to_qeue_schedule extends \artsoft\db\BaseMigration
{
    public function up()
    {
        $this->insert('{{%queue_schedule}}', ['class' => 'console\jobs\ClianLogSessions', 'title' => 'Удаление сессий ботов и завершенных сессий', 'content' => 'Удаляет все сессии ботов и завершенные сессии.', 'cron_expression' => '0 1 * * *', 'priority' => 1024 ,'created_at' => time(), 'updated_at' => time(), 'created_by' => 10000, 'updated_by' => 10000]);
