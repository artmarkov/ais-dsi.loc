...
UNION ALL
         (select 0 as studyplan_subject_id,
                 ...
                 inner join teachers_load on (subject_sect_studyplan.id = teachers_load.subject_sect_studyplan_id and teachers_load.studyplan_subject_id = 0 and teachers_load.load_time_consult > 0)
                 left join consult_schedule  on (consult_schedule.teachers_load_id = teachers_load.id)
			  )
