...
class m250524_224018_add_new_job extends \artsoft\db\BaseMigration
{
    public function up()
    {
        ...
        $this->insert('{{%queue_schedule}}', ['class' => 'console\jobs\LessonAddTask', 'title' => 'Заполнение журнала согласно рассписания занятий', 'content' => 'Автоматически заполняет журнал успеваемости согласно расписанию занятий на текущий день. Проставляет всем ученикам посещение - *', 'cron_expression' => '30 6 * * 1-6', 'priority' => 1024 ,'created_at' => time(), 'updated_at' => time(), 'created_by' => 10000, 'updated_by' => 10000]);
    }
