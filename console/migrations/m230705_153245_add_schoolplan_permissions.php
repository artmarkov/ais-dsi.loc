        ...
        return [
            'schoolplanManagement' => [
                'links' => [
                    ...
                    '/admin/schoolplan/default/activity/*',
                ...
                'viewschoolplan' => [
                    ...
                    'links' => [
                        ...
                        '/schoolplan/default/activity',
                        '/schoolplan/default/activity?mode=view',
                        '/schoolplan/default/activity?mode=update',
                        '/schoolplan/default/activity?mode=create',
                        '/schoolplan/default/activity?mode=delete',
                ...
                'fullschoolplanAccess' => [
                    ...
                    'linkАттестационная карточкаs' => [
                        ...
                        '/admin/schoolplan/default/activity',
                        '/admin/schoolplan/default/activity?mode=create',
                        '/admin/schoolplan/default/activity?mode=view',
                        '/admin/schoolplan/default/activity?mode=update',
                        '/admin/schoolplan/default/activity?mode=delete',
                        '/admin/schoolplan/default/activity?mode=history',
                        '/admin/schoolplan/default/activity-bulk-delete',
