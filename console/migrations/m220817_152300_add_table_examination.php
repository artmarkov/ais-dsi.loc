...
class m220817_152300_add_table_examination extends \artsoft\db\BaseMigration
{
    ...
    public function up()
    {
        ...
        $this->createTableWithHistory('entrant', [
            ...
            'last_experience' => $this->string(127)->comment('Где обучался ранее'),
            'remark' => $this->string(127)->comment('Примечание'),
            ...
            'subject_id' => $this->integer()->defaultValue(null)->comment('Назначена специальность'),
