...
class m210301_151108_create_table_venue extends Migration
{
    public function up()
    {
        ...
        $this->addForeignKey('venue_place_ibfk_4', 'venue_place', 'created_by', 'users', 'id', 'NO ACTION', 'NO ACTION');
        $this->addForeignKey('venue_place_ibfk_5', 'venue_place', 'updated_by', 'users', 'id', 'NO ACTION', 'NO ACTION');
        ...
        $this->db->createCommand()->batchInsert('venue_sity', ['id', 'country_id', 'name', 'latitude', 'longitude'], [
        ...
        $this->db->createCommand()->batchInsert('venue_place', ['id', 'country_id', 'sity_id', 'district_id', 'name', 'address', 'phone', 'phone_optional', 'email', 'сontact_person', 'coords', 'map_zoom', 'description', 'created_at', 'updated_at', 'created_by', 'updated_by'], [
            [1, 643, 1, 1, 'Московский государственный колледж музыкального исполнительства имени Ф.Шопена', 'Россия, Москва, Садовая-Каретная улица, 4-6с7', '+7 (495) 699 70 27', '', 'info@mgkmi.ru', '', '55.771628812087584,37.606928576721195', 17, '', 1539164286, 1543304451, 1, 1,],
            [2, 643, 1, 1, 'Детская музыкальная школа имени Ю.А.Шапорина «Московский государственный институт музыки имени А.Г.Шнитке»', 'Россия, Москва, Садовая-Сухаревская улица, 7', '+7 (495) 694 04 96', '', 'schnittke@yandex.ru', '', '55.774287007241504,37.62258772883362', 15, '', 1539164384, 1543085348, 1, 1,],
            [3, 643, 1, 1, 'Детская музыкальная школа имени В.И.Мурадели', 'Россия, Москва, улица Пречистенка, 32/1с1', '+7 (495) 637 37 83', '', 'tokmakovms_I_@yandex.ru', '', '55.740544683933614,37.59049519510645', 16, '', 1539164434, 1542977663, 1, 1,],
            [4, 643, 1, 1, 'Московская городская детская музыкальная школа имени С.С.Прокофьева', 'Россия, Москва, Токмаков переулок, 8', '+7 (499) 261 24 05', '', 'tokmakovmsI@yandex.ru', '', '55.76630041695248,37.66936464418031', 15, '', 1539164468, 1543010315, 1, 1,],
            [5, 643, 1, 1, 'Детская музыкальная школа имени К.Н.Игумнова', 'Россия, Москва, улица Покровка, 39с3', '+7 (495) 917 56 77', '', 'igumnovschool@yandex.ru', '', '55.7623792908881,37.65125905522533', 19, '', 1539164497, 1543008723, 1, 1,],
            [6, 643, 1, 1, 'Детская музыкальная школа, имени В.В.Стасова', 'Россия, Москва, Малый Строченовский переулок, 14', '+7 (499) 236 18 15', '+7 (499) 236 30 72', 'dmsh36stasova@mait.ru', '', '55.726074835423354,37.63299466137696', 13, '', 1539164525, 1543088776, 1, 1,],
            [7, 643, 1, 1, 'Детская музыкальная школа имени Л.Бетховена', 'Россия, Москва, Большой Могильцевский переулок, 4-6', '+7 (499) 241 41 23', '', 'beethoven-sch@mail.ru', '', '55.74391499999375,37.589709381614654', 17, '', 1539164557, 1543008635, 1, 1,],
            [8, 643, 1, 1, 'Детская музыкальная школа имени А.К.Лядова', 'Россия, Москва, улица 1905 года, 8', '+7 (499) 252 26 23', '', 'dmsh-ljadova@yandex.ru', '', '55.767111487423605,37.56011331779074', 16, '', 1539164587, 1543008774, 1, 1,],
            [9, 643, 1, 1, 'Детская музыкальная школа имени Д.Б.Кабалевского', 'Россия, Москва, улица Палиха, 14/33с1', '+7 (499) 973 22 47', '', '9784364@mail.ru', '', '55.7846275448095,37.60090467692327', 16, '', 1539164629, 1543008815, 1, 1,],
            [10, 643, 1, 1, 'Детская школа искусств «Старт» архитсктурно-художественного профиля', 'Россия, Москва, Зоологическая улица, 18', '+7 (499) 766 29 79', '+7 (499) 766 21 72', 'startartschooi@gmail.com', '', '55.76519136612558,37.582713754631044', 16, '', 1539164672, 1543008861, 1, 1,],
            [11, 643, 1, 1, 'Детская школа искусств имени Д.С.Бортнянского', 'Россия, Москва, Садовническая улица, 19с1', '+7 (495) 953 91 39', '+7 (495) 953 54 41', 'postbortnyanskiy@mail.ru', '', '55.74676760114218,37.63288816931151', 16, '', 1539164706, 1543008901, 1, 1,],
            [12, 643, 1, 1, 'Детская школа искусств имени Н.Г.Рубинштейна', 'Россия, Москва, Верхняя Красносельская улица, 7Ас1', '+7 (499) 264 89 47', '', 'dmsrubinstein@mail.ru', '', '55.78544140418692,37.66182227116391', 16, '', 1539164737, 1543008947, 1, 1,],
            [13, 643, 1, 1, 'Детская  музыкальная школа им. Р.М.Глиэра', 'Россия, Москва, Глазовский переулок, 4', '+7 (297) 499 23 87', '+7 (499) 238 12 00', 'info@glier7.ru', '', '55.74445057720877,37.587718364417995', 16, '', 1539164784, 1543009021, 1, 1,],
            [14, 643, 1, 1, 'Детская музыкально-хоровая школа  имени И.И.Радченко', 'Россия, Москва, Воронцовская улица, 30А', '+7 (495) 912 75 85', '', 'ms-radchenko@yandex.ru', '', '55.73580977355331,37.65999281349181', 16, '', 1539164825, 1543009086, 1, 1,],
            [15, 643, 1, 1, 'Московская городская детская музыкальная школа имени В.М.Блажевича', 'Россия, Москва, улица Трёхгорный Вал, 2-4с1', '+7 (495) 605 94 36', '', 'mail@ms80.ru', '', '55.758629149360665,37.56237875463096', 16, '', 1539164946, 1543009161, 1, 1,],
            [16, 643, 1, 1, 'Московская государственная,специализированная школа акварели Сергея Андрияки с музейно-выставочным комплексом', 'Россия, Москва, Гороховский переулок, 17', '+7 (495) 632 18 17', '', 'sheryshowa@yandex.ru', '', '55.765402599507624,37.66760645573412', 16, '', 1539165042, 1543009198, 1, 1,],
            [17, 643, 1, 1, 'Детская музыкальная школа имени В.А.Моцарта', 'Россия, Москва, Таганская улица, 9с5', '+7 (495) 911 99 95', '+7 (495) 912 14 28', 'mozart_00@mail.ru', '', '55.74144870834125,37.66068700859828', 15, '', 1539165078, 1543009242, 1, 1,],
            [18, 643, 1, 1, 'Детская музыкальная школа имени В Ф.Одоевского', 'Россия, Москва, Докучаев переулок, 7с1', '+7 (499) 975 43 74', '+7 (499) 975 37 35', 'odoevsky-dmsh@list.ru', '', '55.774497298912294,37.642776428241696', 15, '', 1539165107, 1543009279, 1, 1,],
            [19, 643, 1, 1, 'Детская музыкальная школа имени Дж Гершвина', 'Россия, Москва, Садовническая улица, 48с3', '+7 (495) 951 43 42', '+7 (495) 951 43 43', 'dmsh6@rambler.ru', '', '55.7442987862894,37.63731390934197', 15, '', 1539165155, 1543092588, 1, 1,],
            [20, 643, 1, 1, 'Детская музыкальная школа №100', 'Россия, Москва, Большая Переяславская улица, 8А', '+7 (495) 684 50 58', '', 'dmshlOO@mail.ru', '', '55.781484551313035,37.64321701719665', 16, '', 1539165180, 1543009365, 1, 1,],
            [21, 643, 1, 1, 'Детская музыкальная школа имени Н.А.Алексеева', 'Россия, Москва, Николоямская улица, 42с1', '+7 (495) 915 01 35', '', 'lexeev-school@yandex.ru', '', '55.747040406738364,37.66003927116392', 15, '', 1539165248, 1543009437, 1, 1,],
            [22, 643, 1, 1, 'Детская музыкальная школа имени М.М.Ипполитова-Иванова', 'Россия, Москва, Воронцовская улица, 15/10с1', '+7 (495) 912 59 93', '', 'ippolitovec@mail.ru', '', '55.738464555796206,37.657315279762265', 15, '', 1539165284, 1543010072, 1, 1,],
            [23, 643, 1, 1, 'Детская музыкальная школа имени Н.П Осипова', 'Россия, Москва, проспект Мира, 71с3', '+7 (495) 681 35 62', '', 'sch-osipov@bk.ru', '', '55.78821395481633,37.63386687731552', 15, '', 1539165338, 1543010030, 1, 1,],
            [24, 643, 1, 1, 'Детская музыкальная школа имени С.И.Танеева', 'Россия, Москва, Чистый переулок, 9', '+7 (495) 637 35 60', '', 'taneev25@mail.ru', '', '55.74275732649713,37.59076784494787', 15, '', 1539165417, 1543010000, 1, 1,],
            [25, 643, 1, 1, 'Детская художественная школа имени В. А. Ватагина', 'Россия, Москва, Средняя Переяславская улица, 7/2с1', '+7 (495) 681 82 00', '', 'artschool-3@yandex.ru', '', '55.78871986334767,37.6371536269821', 15, '', 1539165462, 1543009959, 1, 1,],
            [26, 643, 1, 1, 'Детская музыкальная школа имени П.Г.Чеснокова', 'Россия, Москва, улица Трёхгорный Вал, 2-4с1', '+7 (499) 255 59 96', '', 'chesnokovschool@mail.ru', '', '55.7586276074644,37.562384119048964', 16, '', 1539165565, 1543009902, 1, 1,],
            [27, 643, 1, 2, 'Детская музыкальная школа имени Я.В.Флиера', 'Россия, Москва, улица Маршала Новикова, 16', '+7 (499) 193 44 89', '', 'dmshflier_16@mail.ru', '', '55.80543719268052,37.460820728835984', 16, '', 1539183299, 1543009866, 1, 1,],
            [28, 643, 1, 2, 'Детская музыкальная школа имени Л.Н.Оборина', 'Россия, Москва, улица Долгова, 12', '+7 (495) 491 14 03', '+7 (495) 491 53 30', 'dmsh_17oborina@mail.ru', '', '55.83040667192069,37.450559101852384', 16, '', 1539183341, 1543009837, 1, 1,],
            [29, 643, 1, 2, 'Детская музыкальная школа имени В.В.Андреева', 'Россия, Москва, Живописная улица, 1', '+7 (495) 942 21 33', '+7 (495) 942 05 52', 'dmsh_andreev@mail.ru', '', '55.780026975695876,37.45279055952453', 15, '', 1539183384, 1543009802, 1, 1,],
            [30, 643, 1, 2, 'Детская музыкальная школа имени Т.А.Докшицера', 'Россия, Москва, Неманский проезд, 7к2', '+7 (495) 756 50 09', '+7 (495) 757 99 67', 'dmsh95@yandex.ru', '', '55.81165341874345,37.393976661376946', 16, '', 1539183440, 1543009769, 1, 1,],
            [31, 643, 1, 2, 'Детская музыкальная школа имени Н.С.Голованова', 'Россия, Москва, улица Мнёвники, 7к1', '+7 (499) 946 26 30', '', 'dmsh.golovanova@yandex.ru', '', '55.771819713615805,37.49317078042606', 15, '', 1539183471, 1543009704, 1, 1,],
            [32, 643, 1, 2, 'Детская школа искусств \"Надежда\"', 'Россия, Москва, улица Академика Курчатова, 23/13', '+7 (495) 942 40 27', '', 'dshi4nadezhda@ya.ru', '', '55.80649703640879,37.476955568276786', 15, '', 1539183520, 1543009675, 1, 1,],
            [33, 643, 1, 2, 'Детская музыкальная школа имени С.М.Майкапара', 'Россия, Москва, улица Маршала Катукова, 19к3', '+7 (495) 750 07 17', '+7 (495) 757 42 64', 'msm_school@mail.ru', '', '55.807292451417965,37.411088644180275', 15, '', 1539183562, 1543009592, 1, 1,],
            [34, 643, 1, 2, 'Детская художественная школа имени В.Ф.Стожарова', 'Россия, Москва, улица Народного Ополчения, 7к2', '+7 (499) 199 02 42', '', '', '', '55.77103543072394,37.47215871163938', 18, '', 1539183626, 1543009546, 1, 1,],
