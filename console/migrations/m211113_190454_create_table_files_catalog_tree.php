...
class m211113_190454_create_table_files_catalog_tree extends \artsoft\db\BaseMigration
{
    ...
    public function up()
    {
        ...
        $this->db->createCommand()->batchInsert(self::TABLE_NAME_TREE, ['id', 'root', 'lft', 'rgt', 'lvl', 'name', 'rules_list_read',
            ...
            [1, 1, 1, 2, 0, "Общая информация", "user,department,teacher,employees,student,parents,administrator", "department,teacher,employees,administrator", "", 1, true, false, false, false, true, false, false, false, false, false, false, false, true, time(), 10000],
            [2, 2, 1, 2, 0, "Информация для сотрудников", "employees,administrator", "administrator", "", 1, true, false, false, false, true, false, false, false, false, false, false, false, true, time(), 10000],
            [3, 3, 1, 2, 0, "Информация для преподавателей", "department,teacher,administrator", "department,administrator", "", 1, true, false, false, false, true, false, false, false, false, false, false, false, true, time(), 10000],
            [4, 4, 1, 2, 0, "Информация для учеников", "department,teacher,employees,student,parents,administrator", "department,teacher,administrator", "", 1, true, false, false, false, true, false, false, false, false, false, false, false, true, time(), 10000],
            [5, 5, 1, 2, 0, "Информация для родителей", "department,teacher,employees,parents,administrator", "department,teacher,employees,administrator", "", 1, true, false, false, false, true, false, false, false, false, false, false, false, true, time(), 10000],
        ])->execute();
