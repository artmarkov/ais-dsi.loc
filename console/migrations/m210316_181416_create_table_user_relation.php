...
class m210316_181416_create_table_user_relation extends Migration
{
    public function up()
    {
        ...
        $this->db->createCommand()->batchInsert('{{%user_relation}}', ['id', 'name', 'slug'], [
            [1, 'Мать', 'Мать'],
            [2, 'Отец', 'Отец'],
            [3, 'Бабушка', 'Баб'],
            [4, 'Дедушка', 'Дед'],
        ...
        $this->addForeignKey('user_family_ibfk_1', '{{%user_family}}', 'user_main_id', '{{%user}}', 'id', 'RESTRICT', 'RESTRICT');
        $this->addForeignKey('user_family_ibfk_2', '{{%user_family}}', 'user_slave_id', '{{%user}}', 'id', 'RESTRICT', 'RESTRICT');
        $this->addForeignKey('user_family_ibfk_3', '{{%user_family}}', 'relation_id', '{{%user_relation}}', 'id', 'RESTRICT', 'RESTRICT');
