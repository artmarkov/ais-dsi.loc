...
class m210301_150355_create_table_own extends \artsoft\db\BaseMigration
{
    public function up()
    {
        ...
        $this->db->createCommand()->batchInsert('guide_department', ['id', 'division_id', 'name', 'slug', 'status'], [
            ...
            [1010, 1000, 'Отделение развития МО', 'ОР МО', 1],
            [1011, 1002, 'Хореография', 'Хореография', 1],
            [1012, 1000, 'Музыкальный театр', 'Театр', 1],
            [1013, 1000, 'Академический вокал', 'Ак.вок', 1],
            [1014, 1000, 'Сценическое мастерство', 'Сцен.маст-во', 1],
            [1015, 1000, 'Эстрадный вокал', 'Эстр.вок.', 1],
            [1016, 1001, 'Изобразительное искусство', 'ИЗО', 1],
            [1017, 1003, 'Театральное искусство', 'ТИ', 1],
        ])->execute();

        $this->db->createCommand()->resetSequence('guide_department', 1018)->execute();
