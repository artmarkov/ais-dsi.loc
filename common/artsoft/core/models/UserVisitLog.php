...
class UserVisitLog extends ActiveRecord
{
    ...
    {
        return Yii::$app->art->user_visit_log_table;
    }
    ...
    public function attributeLabels()
    {
        return [
            'id' => Yii::t('art', 'ID'),
            'token' => Yii::t('art', 'Token'),
            'ip' => Yii::t('art', 'IP'),
            'language' => Yii::t('art', 'Language'),
            'browser' => Yii::t('art', 'Browser'),
            'os' => Yii::t('art', 'OS'),
            'user_agent' => Yii::t('art', 'User agent'),
            'user_id' => Yii::t('art', 'User'),
            'visit_time' => Yii::t('art', 'Visit Time'),
        ];
    }
