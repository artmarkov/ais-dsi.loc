...
abstract class AbstractItem extends ActiveRecord
{
    ...
    public static function removeChildren($parentName, $childrenNames)
    {
        ...
        foreach ($childrenNames as $childName) {
            Yii::$app->db->createCommand()
                    ->delete(Yii::$app->art->auth_item_child_table, ['parent' => $parentName, 'child' => $childName])
                    ->execute();
        }
    ...
    {
        return Yii::$app->art->auth_item_table;
    }
...
//    }
    ...
    {
        return parent::find()->andWhere([Yii::$app->art->auth_item_table . '.type' => static::ITEM_TYPE]);
    }
    ...
    public function attributeLabels()
    {
        return [
            'name' => Yii::t('art', 'Code'),
            'description' => Yii::t('art', 'Role'),
            'rule_name' => Yii::t('art', 'Rule'),
            'group_code' => Yii::t('art', 'Group'),
            'data' => Yii::t('art', 'Data'),
            'type' => Yii::t('art', 'Type'),
