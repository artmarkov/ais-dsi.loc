...
use artsoft\user\models\search\RoleSearch;
use Yii;
...
class RoleController extends MainController
{
     ...
     * @var Role
     */
    public $modelClass = 'artsoft\models\Role';

    /**
     * @var RoleSearch
     */
    public $modelSearchClass = 'artsoft\user\models\search\RoleSearch';
    ...
    public function actionView($id)
    {
        ...
        $permissions = Permission::find()
            ->andWhere(Yii::$app->art->auth_item_table . '.name != :commonPermissionName',
                [':commonPermissionName' => Yii::$app->art->commonPermissionName])
            ->joinWith('group')
            ->all();
