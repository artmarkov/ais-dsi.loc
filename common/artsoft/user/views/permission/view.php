...
$this->title = Yii::t('art/user', '{permission} Permission Settings', ['permission' => $item->description]);
...
?>
    <div class="panel">
        <div class="panel-heading">
            ...
            <?= \artsoft\helpers\ButtonHelper::updateButton($model, ['update', 'id' => $item->name]);?>
