...
return [
    ...
    'Mark Rem' => 'Комментарий',
    'Early_Education' => 'Досрочное завершение обучения(выпускник)',
    'Cond_Education' => 'План открыт условно',
    'Qualifications' => 'Показатели ППК',
    'Name PPK' => 'Название ППК',
    'Place PPK' => 'Место прохождения ППК',
    'Date PPK' => 'Дата выдачи удостоверения ППК',
    'Description PPK' => 'Краткое описание ППК',
];
?>
