...
class EntrantPreregistrations extends \artsoft\db\ActiveRecord
{
    ...
    public function sendMessage($email)
    {
        if ($email) {
            ...
            $textBody .= 'Если есть вопросы, просьба связаться по телефонам:  8 926 350 17 97 Анастасия Владимировна, 8 977 118 76 38 Александр Александрович' . PHP_EOL;
            $htmlBody .= '<p>Если есть вопросы, просьба связаться по телефонам:  8 926 350 17 97 Анастасия Владимировна, 8 977 118 76 38 Александр Александрович' . '</p>';
