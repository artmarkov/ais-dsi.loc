...
class StudyplanDistrib
{
    ...
    public function getData()
    {
        ...
        $mask = [
            ...
            '14' => [['Гусли'], []],
            '15' => [['Гармонь'], []],
            '17' => [['Флейта'], [1004,1005,1017,1018]],
            '18' => [['Гобой'], [1004,1005,1017,1018]],
            '19' => [['Кларнет'], [1004,1005,1017,1018]],
            '20' => [['Фагот'], [1004,1005,1017,1018]],
            '21' => [['Саксофон'], [1004,1005,1017,1018]],
            '22' => [['Труба'], [1004,1005,1017,1018]],
            '23' => [['Валторна'], [1004,1005,1017,1018]],
            '24' => [['Трамбон', 'Баритон', 'Тенор', 'Альт'], [1004,1005,1017,1018]],
            '25' => [['Туба'], [1004,1005,1017,1018]],
            '26' => [['Ударные'], [1004,1005,1017,1018]],
            '28' => [['Скрипка'], []],
            '29' => [['Виолончель'], []],
            '30' => [[], []],
            '31' => [['Контрабас'], []],
            '32' => [['Арфа'], []],
            '33' => [['Ударные', 'Саксофон', 'Бас-гитара', 'Тромбон', 'Труба', 'Электрогитара'], [1011, 1012, 1024, 1025]],
            '34' => [['Хор'], []],
