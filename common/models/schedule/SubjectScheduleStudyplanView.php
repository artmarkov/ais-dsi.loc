...
use common\models\schedule\search\SubjectSectScheduleViewSearch;
 ...
 * @property string|null $subject_sect_studyplan_id
 ...
 */
class SubjectScheduleStudyplanView extends SubjectSchedule
{
