...
class ConsultScheduleConfirm extends \artsoft\db\ActiveRecord
{
        ...
        return [
            ...
            [['sign_message'], 'required', 'when' => function ($model) {
                ...
                'whenClient' => "function (attribute, value) {
                                return $('input[id=\"consultscheduleconfirm-admin_flag\"]').prop('checked');
                            }"],
    ...
    public function sendAdminMessage()
    {
        if ($this->sign_message != '') {
            ...
            $textBody .= 'Прошу Вас внести уточнения в Расписание занятий консультаций на: ' . strip_tags(ArtHelper::getStudyYearsValue($this->plan_year)) . ' ������� ���. ' . PHP_EOL;
            $htmlBody .= '<p>Прошу Вас внести уточнения в Расписание занятий консультаций на:' . strip_tags(ArtHelper::getStudyYearsValue($this->plan_year)) . ' ������� ���. ' . '</p>';
