...
class TarifStatement
{
    ...
    protected $is_week_load;
    protected $is_consult;
    protected $print_summ;
    protected $print_stat;
    protected $del_free;
    protected $subject_type_id;
    protected $norma_teach = 72;
    protected $norma_accomp = 96;
...
//    protected $teachers_day_consult_total;
    ...
    public function __construct($model_date)
    {
        ...
        $this->is_week_load = $model_date->is_week_load ?? false;
        $this->is_consult = $model_date->is_consult ?? false;
        $this->print_summ = $model_date->print_summ ?? false;
        $this->print_stat = $model_date->print_stat ?? false;
        $this->del_free = $model_date->del_free ?? false;
