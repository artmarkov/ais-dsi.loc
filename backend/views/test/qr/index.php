...
echo Text::widget([
    ...
    'text' => 'ST00012|Name=Департамент Финансов города Москвы (Государственное бюджетное учреждение дополнительного образования города Москвы «Детская школа искусств имени И.Ф. Стравинского»)|PersonalAcc=03224643450000007300|BankName=ГУ Банка России по ЦФО//УФК по г.Москве г.Москва|PersonalAcc=0322464345|BIC=004525988|CorrespAcc=40102810545370000003|Sum=200000|Purpose=Консультации для поступающих на музыкальное отделение|PayeeINN=7733098705|KPP=773301001|CBC=05600000000131131022|OKATO=',
    'size' => 3,
]);
?>
    <hr>
...
echo Text::widget([
    ...
    'outputDirWeb' => '@web/upload/qrcode',
    'ecLevel' => QRcode::QR_ECLEVEL_L,
    'text' => 'ST00012|Name=Департамент Финансов города Москвы (Государственное бюджетное учреждение дополнительного образования города Москвы «Детская школа искусств имени И.Ф. Стравинского»)|PersonalAcc=03224643450000007300|BankName=ГУ Банка России по ЦФО//УФК по г.Москве г.Москва|PersonalAcc=0322464345|BIC=004525988|CorrespAcc=40102810545370000003|Sum=300000|Purpose=Консультации для поступающих на художественное отделение|PayeeINN=7733098705|KPP=773301001|CBC=05600000000131131022|OKATO=',
    'size' => 3,
]);
?>
    <hr>
