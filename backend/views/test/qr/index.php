...
echo Text::widget([
    ...
    'text' => 'ST00012|Name=Департамент финансов города Москвы (ГБУДО г. Москвы "ДШИ им. И.Ф.Стравинского", л/с 2605642000830080)|PersonalAcc=03224643450000007300|BankName=ГУ Банка России по ЦФО//УФК по г.Москве г.Москва|PersonalAcc=0322464345|BIC=004525988|CorrespAcc=40102810545370000003|Sum=200000|Purpose=Консультации для поступающих на музыкальное отделение|PayeeINN=7733098705|KPP=773301001|CBC=05600000000131131022|ОКТМО=45367000',
    'size' => 3,
]);
?>
    <hr>
