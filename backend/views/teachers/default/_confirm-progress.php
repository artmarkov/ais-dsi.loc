    ...
    <div class="sect-search">
        <div class="panel panel-default">
            <div class="panel-heading">
                Статус проверки журнала
            </div>
            <div class="panel-body">
                <?php if (\artsoft\Art::isFrontend() && $readonly): ?>
                    <?php echo \yii\bootstrap\Alert::widget([
                        'body' => '<i class="fa fa-info-circle"></i> Для отправки на утверждение заполните журнал успеваемости за период.',
                ...
                <div class="row">
                    ...
                    echo Html::activeHiddenInput($model_confirm, 'timestamp_month');
                    echo Html::activeHiddenInput($model_confirm, 'subject_sect_studyplan_id');
                    ?>
                    <?php
                    ...
                    <?= $form->field($model_confirm->loadDefaultValues(), 'confirm_status')->widget(\kartik\select2\Select2::class, [
                        'data' => \common\models\education\ProgressConfirm::getDocStatusList(),
                        'showToggleAll' => false,
                        'options' => [
                            'disabled' => true,
                            'placeholder' => Yii::t('art', 'Select...'),
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="form-group btn-group pull-right">
                                    <?= Html::submitButton('<i class="fa fa-check" aria-hidden="true"></i> Утвердить', ['class' => 'btn btn-sm btn-success', 'name' => 'submitAction', 'value' => 'approve', 'disabled' => $model_confirm->confirm_status == 1]); ?>
