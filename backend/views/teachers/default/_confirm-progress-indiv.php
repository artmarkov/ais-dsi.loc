...
$form = ActiveForm::begin([
    'id' => 'teachers-confirm-progress-indiv',
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    ...
                    echo Html::activeHiddenInput($model_confirm, 'subject_key');
                    ?>
                    <?php
                    ...
                    <?= $form->field($model_confirm->loadDefaultValues(), 'confirm_status')->widget(\kartik\select2\Select2::class, [
                        'data' => \common\models\education\ProgressConfirmIndiv::getDocStatusList(),
                        'showToggleAll' => false,
                        'options' => [
                            'disabled' => true,
                            'placeholder' => Yii::t('art', 'Select...'),
