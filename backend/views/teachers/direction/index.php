...
$this->title = Yii::t('art/teachers', 'Direction');
...
<div class="direction-index">
    <div class="panel">
        <div class="panel-heading">
            <?= Html::a('<i class="fa fa-plus" aria-hidden="true"></i> ' . Yii::t('art', 'Add New'), ['/teachers/direction/create'], ['class' => 'btn btn-sm btn-default']) ?>
        </div>
