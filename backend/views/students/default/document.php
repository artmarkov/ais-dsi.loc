                    ...
                    GridView::widget([
                        ...
                        'columns' => [
                            ...
                            [
                                ...
                                'title' => function ($model) use ($student_id) {
                                    return Html::a($model->title, ['/students/default/document', 'id' => $student_id, 'objectId' => $model->id, 'mode' => 'view'], ['data-pjax' => 0]);
                                },
                                'buttonsTemplate' => '{update} {view} {delete}',
                                'buttons' => [
                                    'update' => function ($url, $model, $key) use ($student_id) {
                                        return  Html::a(Yii::t('art', 'Edit'),
                                            Url::to(['/students/default/document', 'id' => $student_id, 'objectId' => $model->id, 'mode' => 'update']), [
                                    ...
                                    'view' => function ($url, $model, $key) use ($student_id) {
                                        return  Html::a(Yii::t('art', 'View'),
                                            Url::to(['/students/default/document', 'id' => $student_id, 'objectId' => $model->id, 'mode' => 'view']), [
                                    ...
                                    'delete' => function ($url, $model, $key) use ($student_id) {
                                        return Html::a(Yii::t('art', 'Delete'),
                                            Url::to(['/students/default/document', 'id' => $student_id, 'objectId' => $model->id, 'mode' => 'delete']), [
