        ...
        'buttons' => [
            'create' => function ($key, $model) {
                return Html::a('<span class="glyphicon glyphicon-plus" aria-hidden="true"></span>',
                    ['/studyplan/default/schedule-items', 'id' => $model->studyplan_id, 'load_id' => $model->teachers_load_id, 'mode' => 'create'], [
            ...
            'update' => function ($key, $model) {
                return Html::a('<span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>',
                    ['/studyplan/default/schedule-items', 'id' => $model->studyplan_id, 'objectId' => $model->subject_schedule_id, 'mode' => 'update'], [
            ...
            'delete' => function ($key, $model) {
                return Html::a('<span class="glyphicon glyphicon-trash" aria-hidden="true"></span>',
                    ['/studyplan/default/schedule-items', 'id' => $model->studyplan_id, 'objectId' => $model->subject_schedule_id, 'mode' => 'delete'], [
