    ...
    <div class="panel-body">
        <div class="row">
            <div class="col-sm-12">
                ...
                <?php $age = !$model->isNewRecord ? \artsoft\helpers\ArtHelper::age(Yii::$app->formatter->asTimestamp($model->birth_date)) : [] ;?>
                    <?= $form->field($model, 'birth_date')->widget(MaskedInput::class, ['mask' => Yii::$app->settings->get('reading.date_mask')])->widget(DatePicker::class, ['disabled' => false])->hint(!$model->isNewRecord ? ('Возраст: ' . $age['age_year'] . ' лет ' . $age['age_month'] . ' мес.') : ''); ?>
