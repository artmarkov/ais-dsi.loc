                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <?= $form->field($model,  'inn')->textInput(['maxlength' => true, 'disabled' => $readonlyParents])->hint('Введите ИНН, если Вы планируете в дальнейшем оформить налоговый вычет за обучение ребенка.') ?>
