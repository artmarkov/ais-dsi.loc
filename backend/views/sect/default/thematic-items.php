        ...
        'buttons' => [
            'create' => function ($key, $model) {
                if ($model->subject_sect_studyplan_id == null) {
                    return Html::a('<span class="glyphicon glyphicon-plus" aria-hidden="true"></span>',
                       ['/sect/default/thematic-items', 'id' => $model->subject_sect_id, 'studyplan_subject_id' => $model->studyplan_subject_id, 'mode' => 'create'], [
                    ...
                    return Html::a('<span class="glyphicon glyphicon-plus" aria-hidden="true"></span>',
                       ['/sect/default/thematic-items', 'id' => $model->subject_sect_id, 'subject_sect_studyplan_id' => $model->subject_sect_studyplan_id, 'mode' => 'create'], [
                            'title' => Yii::t('art', 'Create'),
                            'data-method' => 'post',
                            'data-pjax' => '0',
                            'disabled' => true
            ...
            'view' => function ($key, $model) {
                return Html::a('<span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span>',
                    ['/sect/default/thematic-items', 'id' => $model->subject_sect_id, 'objectId' => $model->studyplan_thematic_id, 'mode' => 'view'], [
            ...
            'update' => function ($key, $model) {
                return Html::a('<span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>',
                    ['/sect/default/thematic-items', 'id' => $model->subject_sect_id, 'objectId' => $model->studyplan_thematic_id, 'mode' => 'update'], [
            ...
            'delete' => function ($key, $model) {
                return Html::a('<span class="glyphicon glyphicon-trash" aria-hidden="true"></span>',
                    ['/sect/default/thematic-items', 'id' => $model->subject_sect_id, 'objectId' => $model->studyplan_thematic_id, 'mode' => 'delete'], [
...
<div class="studyplan-thematic-index">
    <div class="panel">
        <div class="panel-heading">
            Тематические/репертуарные планы:  <?php echo RefBook::find('sect_name_4')->getValue($model->id);?>
        </div>
