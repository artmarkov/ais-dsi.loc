...
?>
<div class="entrant-preregistrations-summary-index">
    <div class="panel">
        <div class="panel-heading">
           Результаты предварительной записи
            ...
            GridView::widget([
                ...
                'columns' => [
                    ...
                    [
                        ...
                        'value' => function (EntrantPreregistrations $model) {
                            return \common\models\education\EntrantProgramm::getEntrantProgrammList()[$model->entrant_programm_id];
                        },
                        'format' => 'raw',
                    ],
                    [
