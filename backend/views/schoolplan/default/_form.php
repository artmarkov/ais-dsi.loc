    ...
    <div class="panel">
        ...
        <div class="panel-body">
            <?= \yii\bootstrap\Alert::widget([
                'body' => '<i class="fa fa-info"></i> <b>Внимание!</b> При планировании проведения мероприятий в большом зале учитывать следующее:</br> 1. Концерты (отчетные) проводить через  1 день;</br> 2. Концерты нельзя проводить одновременно в малом и большом залах;</br> 3. При планировании концерта нельзя планировать зал в этот же день для проведения репетиций, не связанных с концертами;',
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <?= $form->field($model, 'formPlaces')->radioList(Schoolplan::getFormPlacesList(), ['itemOptions' => ['disabled' => $readonly]]) ?>
