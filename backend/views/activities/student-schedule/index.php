...
$this->title = 'Ежедневник по ученикам';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="activities-student-index">
    <div class="panel">
        <div class="panel-heading">
            <?= Html::encode($this->title) ?>
            <?= !User::hasRole(['student'], false) ? $this->render('_search', compact('model_date')) : '' ?>
        </div>
...
//                    'eventResize' => new JsExpression($JSEventResize),
                ...
                'events' => \yii\helpers\Url::to(['/activities/student-schedule/init-calendar', 'student_id' => $model_date->student_id]),
            ]);
            ?>
        </div>
    </div>
