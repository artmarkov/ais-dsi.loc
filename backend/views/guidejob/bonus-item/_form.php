            ...
            <div class="panel panel-default">
                ...
                <div class="panel-footer">
                    <div class="form-group">
                        <?= Html::a('<i class="fa fa-list" aria-hidden="true"></i> ' . Yii::t('art', 'Go to list'), ['/guidejob/bonus-item/index'], ['class' => 'btn btn-default']) ?>
                        ...
                        <?php if (!$model->isNewRecord): ?>
                            <?= Html::a('<i class="fa fa-trash-o" aria-hidden="true"></i> ' . Yii::t('art', 'Delete'),
                                ['/guidejob/bonus-item/delete', 'id' => $model->id], [
