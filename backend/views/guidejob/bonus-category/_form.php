...
/* @var $model common\models\guidejob\BonusCategory */
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-footer">
                    <div class="form-group">
                        <?= Html::a('<i class="fa fa-list" aria-hidden="true"></i> ' . Yii::t('art', 'Go to list'), ['/guidejob/bonus-category/index'], ['class' => 'btn btn-default']) ?>
                        ...
                        <?php if (!$model->isNewRecord): ?>
                            <?= Html::a('<i class="fa fa-trash-o" aria-hidden="true"></i> ' . Yii::t('art', 'Delete'),
                                ['/guidejob/bonus-category/delete', 'id' => $model->id], [
